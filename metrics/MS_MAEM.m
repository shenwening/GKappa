% MS_MAEM
function [ maem, ret ] = MS_MAEM( v1, v2 );
%% [create] function for the ordinal measure MAE_M, by zim 2022/5/10 
%% [modify] Note that it is asymmetric,  i.e., MS_MAEM(A, B) ~= MS_MAEM(B, A)
...
if (bExample == 1)
    ...
    v1 = [1 1 1 2 2 3 3 3 3];
    v2 = [3 3 3 2 2 2 1 1 1];
    v2 = v1;
    % v2 = [2 2 1 1 1 1];
...
maem = sum(sum(W.*mat, 1)./vClassLength2)/nnz(vClassLength2)
